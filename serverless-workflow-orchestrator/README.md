# serverless-workflow-orchestrator Project
...
You can then execute your native executable with: `./target/serverless-workflow-orchestrator-1.0.0-SNAPSHOT-runner`
